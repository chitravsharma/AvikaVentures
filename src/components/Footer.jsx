    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <p className="footer-desc">
              Empowering businesses with innovative software solutions and modern web development services.
            </p>
        ...
        <div className="footer-bottom">
          <p>&copy; {new Date().getFullYear()} Avika Ventures. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
